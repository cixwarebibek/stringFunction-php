...
<?php
 ...
 $vowelsA = str_replace("a","A","$str");

 $vowelsE = str_replace("e","E","$vowelsA");
 $vowelsI = str_replace("i","I","$vowelsE");
 $vowelsO = str_replace("o","O","$vowelsI");
 $vowelsU = str_replace("u","U","$vowelsO");
